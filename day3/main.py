...
def draw_grid():
    ...
    for y in range(len(grid.active_grid)):
        for x in range(len(grid.active_grid[y])):
            value = grid.active_grid[y][x]
            if value != 0:
